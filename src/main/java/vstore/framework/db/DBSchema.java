...
public class DBSchema {
     ...
     * {@link VStore#store(String, boolean)} method.
     */
    ...
    public static final class RulesTable {
        ...
        public static final String STORE_MULTIPLE = "store_multiple";
        public static final String REPLICATION_FACTOR = "replication_factor"; // INTEGER
        public static final String DETAIL_SCORE = "detail_score"; // REAL

        private static final String[] COLUMNS = {ID, NAME, DATE_CREATION, CONTEXTJSON,
                SHARING_DOMAIN, WEEKDAYS, TIME_START, TIME_END, FILE_SIZE, IS_GLOBAL,
                STORE_MULTIPLE, REPLICATION_FACTOR, DETAIL_SCORE};
