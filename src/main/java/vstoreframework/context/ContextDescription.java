...
import vstoreframework.context.types.place.PlaceType;
...
public class ContextDescription implements Serializable {
    ...
    public ContextDescription(String json) {
        ...
        String jPlaces = null;
        String jActivity = null;
        String jNetwork = null;
        String jNoise = null;
        int weekday = -1;
        long timestamp = 0;
        ...
        try {
            ...
            try {
	            jLocation = (String)j.get("location");
	            jPlaces = (String)j.get("places");
	            jActivity = (String)j.get("activity");
	            jNetwork = (String)j.get("network");
	            jNoise = (String)j.get("noise");
	            timestamp = (long)j.get("timestamp");
	            weekday = (int)j.get("weekday");
