...
import static vstoreframework.node.NodeType.CLOUD;
import static vstoreframework.node.NodeType.CLOUDLET;
import static vstoreframework.node.NodeType.CORENET;
import static vstoreframework.node.NodeType.GATEWAY;
import static vstoreframework.node.NodeType.OWNCLOUD;
import static vstoreframework.node.NodeType.PHONE;
import static vstoreframework.node.NodeType.UNKNOWN;
...
import vstoreframework.context.RuleContextDescription;
import vstoreframework.context.types.place.VPlaces;
import vstoreframework.context.types.place.VSinglePlace;
...
import vstoreframework.logging.log_events.LogMatchingAddRuleEvent;
